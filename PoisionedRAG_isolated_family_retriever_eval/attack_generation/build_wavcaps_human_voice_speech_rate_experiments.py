...
MALICIOUS_METADATA = Path("malicious_dataset/unified_human_voice_speech_20/final_dataset/metadata.json")
OUTPUT_DIR = Path("attack_experiments/wavcaps_human_voice_speech_rates")
TARGET_CLASS = "human_voice_speech"
TARGET_CLASS_SIZE = 102
RATES = [1, 5, 10, 15, 20]
SEED = 7
