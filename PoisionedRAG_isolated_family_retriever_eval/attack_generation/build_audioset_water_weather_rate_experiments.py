...
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_water_weather_14/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_water_weather_rates")
TARGET_CLASS = "water_weather"
TARGET_CLASS_SIZE = 72
RATES = [1, 5, 10, 15, 20]
SEED = 7
