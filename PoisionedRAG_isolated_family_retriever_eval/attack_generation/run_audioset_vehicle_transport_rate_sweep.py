...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "audioset_vehicle_transport_rates" / "experiment_plan.json"
MALICIOUS_METADATA = (
    REPO_ROOT
    / "malicious_dataset"
    / "wavcaps_clotho_esc50_to_audioset_vehicle_transport_57"
    / "final_dataset"
    / "query_subset_20.json"
)
OUTPUT_DIR = REPO_ROOT / "outputs" / "audioset_vehicle_transport_rate_sweep"
