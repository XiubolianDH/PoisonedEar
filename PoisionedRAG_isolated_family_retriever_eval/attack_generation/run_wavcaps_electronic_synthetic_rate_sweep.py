...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_electronic_synthetic_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_electronic_synthetic_35" / "final_dataset" / "query_subset_20.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_electronic_synthetic_rate_sweep"
