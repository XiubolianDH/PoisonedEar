...
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_machine_mechanical_16/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_machine_mechanical_rates")
TARGET_CLASS = "machine_mechanical"
TARGET_CLASS_SIZE = 80
RATES = [1, 5, 10, 15, 20]
SEED = 7
