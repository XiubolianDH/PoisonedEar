...
MALICIOUS_METADATA = Path("malicious_dataset/unified_electronic_synthetic_35/final_dataset/metadata.json")
OUTPUT_DIR = Path("attack_experiments/wavcaps_electronic_synthetic_rates")
TARGET_CLASS = "electronic_synthetic"
TARGET_CLASS_SIZE = 165
RATES = [1, 5, 10, 15, 20]
SEED = 7
