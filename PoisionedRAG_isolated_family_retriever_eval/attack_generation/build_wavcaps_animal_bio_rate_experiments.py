...
MALICIOUS_METADATA = Path("malicious_dataset/unified_animal_bio_11/final_dataset/metadata.json")
OUTPUT_DIR = Path("attack_experiments/wavcaps_animal_bio_rates")
TARGET_CLASS = "animal_bio"
TARGET_CLASS_SIZE = 58
RATES = [1, 5, 10, 15, 20]
SEED = 7
