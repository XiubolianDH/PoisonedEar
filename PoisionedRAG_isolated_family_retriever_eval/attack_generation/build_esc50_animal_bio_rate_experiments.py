...
BASE_CLASSIFIED = Path("classified_dataset/esc50/metadata_classified.jsonl")
BASE_MANIFEST = Path("outputs/manifests/esc50_clean.jsonl")
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_esc50_animal_bio_72/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/esc50_animal_bio_rates")
TARGET_CLASS = "animal_bio"
TARGET_CLASS_SIZE = 480
RATES = [1, 5, 10, 15, 20]
SEED = 7
...
def main() -> None:
    ...
    for rate in RATES:
        ...
        manifest_out = rate_dir / "esc50_poisoned_manifest.jsonl"
        ...
        subset_payload = {
            "dataset_name": f"esc50_{TARGET_CLASS}_{rate:02d}pct",
