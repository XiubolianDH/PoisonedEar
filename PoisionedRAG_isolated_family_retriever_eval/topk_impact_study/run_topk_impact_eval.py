...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--retriever-encoder", default=None, help="Retriever encoder to evaluate.")
...
def main() -> None:
    ...
    for k in args.k_values:
        ...
        if args.retriever_encoder:
            cmd.extend(["--retriever-encoder", args.retriever_encoder])
        ...
        print(
            f"[RUN] retriever={args.retriever_encoder or 'config-default'} "
            f"poison_rate={args.poison_rate_pct}% top_k={k}"
        )
