...
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_animal_bio_32/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_animal_bio_rates")
TARGET_CLASS = "animal_bio"
TARGET_CLASS_SIZE = 164
RATES = [1, 5, 10, 15, 20]
SEED = 7
