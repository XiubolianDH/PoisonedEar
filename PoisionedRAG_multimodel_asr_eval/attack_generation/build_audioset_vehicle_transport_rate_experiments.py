...
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_vehicle_transport_57/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_vehicle_transport_rates")
TARGET_CLASS = "vehicle_transport"
TARGET_CLASS_SIZE = 286
RATES = [1, 5, 10, 15, 20]
SEED = 7
