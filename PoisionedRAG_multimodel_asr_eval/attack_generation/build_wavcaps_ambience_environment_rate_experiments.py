...
MALICIOUS_METADATA = Path("malicious_dataset/unified_ambience_environment_2/final_dataset/metadata.json")
OUTPUT_DIR = Path("attack_experiments/wavcaps_ambience_environment_rates")
TARGET_CLASS = "ambience_environment"
TARGET_CLASS_SIZE = 11
RATES = [1, 5, 10, 15, 20]
SEED = 7
