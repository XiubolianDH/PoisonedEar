...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_human_voice_speech_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_human_voice_speech_20" / "final_dataset" / "query_subset_20.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_human_voice_speech_rate_sweep"
