...
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_electronic_synthetic_6/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_electronic_synthetic_rates")
TARGET_CLASS = "electronic_synthetic"
