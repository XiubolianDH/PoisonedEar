...
MALICIOUS_METADATA = Path("malicious_dataset/unified_music_instrument_27/final_dataset/metadata.json")
OUTPUT_DIR = Path("attack_experiments/wavcaps_music_instrument_rates")
TARGET_CLASS = "music_instrument"
TARGET_CLASS_SIZE = 137
RATES = [1, 5, 10, 15, 20]
SEED = 7
