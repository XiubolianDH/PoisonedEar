...
MODEL_SPECS = {
    ...
    "gpt_4o_mini_audio_preview": {
        "config": "configs/openai_gpt4o_mini_audio.yaml",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run GPT family attack matrix with fixed k=5 and poison rate 15%.")
    parser.add_argument("--output-root", default="outputs/gpt_family_fixed_k5_15pct_20260420")
...
def main() -> None:
    ...
    summary_csv = output_root / "gpt_family_overall_asr_recall_k5.csv"
    summary_json = output_root / "gpt_family_overall_asr_recall_k5.json"
    fieldnames = [
        "model_key",
        "model_name",
        "dataset",
