...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_ambience_environment_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_ambience_environment_2" / "final_dataset" / "query_subset_all.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_ambience_environment_rate_sweep"
