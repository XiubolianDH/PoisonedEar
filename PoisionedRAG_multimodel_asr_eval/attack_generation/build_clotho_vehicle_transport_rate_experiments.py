...
BASE_CLASSIFIED = Path("classified_dataset/clotho_full/metadata_classified.jsonl")
BASE_MANIFEST = Path("outputs/manifests/clotho_clean.jsonl")
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_clotho_vehicle_transport_556/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/clotho_vehicle_transport_rates")
TARGET_CLASS = "vehicle_transport"
TARGET_CLASS_SIZE = 3712
RATES = [1, 5, 10, 15, 20]
SEED = 7
...
def main() -> None:
    ...
    for rate in RATES:
        ...
        manifest_out = rate_dir / "clotho_poisoned_manifest.jsonl"
        ...
        subset_payload = {
            "dataset_name": f"clotho_{TARGET_CLASS}_{rate:02d}pct",
