...
BASE_CLASSIFIED = Path("classified_dataset/audioset/metadata_classified.jsonl")
BASE_MANIFEST = Path("outputs/manifests/audioset_clean.jsonl")
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_human_voice_speech_88/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_human_voice_speech_rates")
TARGET_CLASS = "human_voice_speech"
TARGET_CLASS_SIZE = 444
RATES = [1, 5, 10, 15, 20]
SEED = 7
...
def main() -> None:
    ...
    for rate in RATES:
        ...
        manifest_out = rate_dir / "audioset_poisoned_manifest.jsonl"
        ...
        subset_payload = {
            "dataset_name": f"audioset_{TARGET_CLASS}_{rate:02d}pct",
