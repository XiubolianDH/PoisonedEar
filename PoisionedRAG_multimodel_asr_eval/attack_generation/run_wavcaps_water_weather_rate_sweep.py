...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_water_weather_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_water_weather_24" / "final_dataset" / "query_subset_20.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_water_weather_rate_sweep"
