...
MALICIOUS_METADATA = Path("malicious_dataset/unified_machine_mechanical_20/final_dataset/metadata.json")
OUTPUT_DIR = Path("attack_experiments/wavcaps_machine_mechanical_rates")
TARGET_CLASS = "machine_mechanical"
TARGET_CLASS_SIZE = 101
RATES = [1, 5, 10, 15, 20]
SEED = 7
