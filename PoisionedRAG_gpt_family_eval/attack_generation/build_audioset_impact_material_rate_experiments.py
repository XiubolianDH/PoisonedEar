...
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_impact_material_13/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_impact_material_rates")
TARGET_CLASS = "impact_material"
TARGET_CLASS_SIZE = 65
RATES = [1, 5, 10, 15, 20]
SEED = 7
