...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_machine_mechanical_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_machine_mechanical_20" / "final_dataset" / "query_subset_20.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_machine_mechanical_rate_sweep"
