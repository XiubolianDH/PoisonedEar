...
MALICIOUS_METADATA = Path("malicious_dataset/unified_water_weather_24/final_dataset/metadata.json")
OUTPUT_DIR = Path("attack_experiments/wavcaps_water_weather_rates")
TARGET_CLASS = "water_weather"
TARGET_CLASS_SIZE = 120
RATES = [1, 5, 10, 15, 20]
SEED = 7
