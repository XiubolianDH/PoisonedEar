...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_music_instrument_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_music_instrument_27" / "final_dataset" / "query_subset_20.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_music_instrument_rate_sweep"
