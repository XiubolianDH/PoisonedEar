...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_vehicle_transport_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_vehicle_transport_20" / "final_dataset" / "metadata.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_vehicle_transport_rate_sweep"
