...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_animal_bio_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_animal_bio_11" / "final_dataset" / "query_subset_all.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_animal_bio_rate_sweep"
