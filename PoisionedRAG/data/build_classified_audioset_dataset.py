...
SOURCE_METADATA = Path("data/full_datasets/audioset/metadata.csv")
OUTPUT_DIR = Path("classified_dataset/audioset")
...
def main() -> None:
    ...
    OUTPUT_README.write_text(
        "\n".join(
            [
                "Separate classified AudioSet view using the same 10-class heuristic taxonomy.",
