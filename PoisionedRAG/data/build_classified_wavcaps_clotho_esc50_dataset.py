...
SOURCE_DATASET = REPO_ROOT / "data/unified_wavcaps_clotho_esc50_dataset.jsonl"
OUTPUT_DIR = REPO_ROOT / "classified_dataset/wavcaps_clotho_esc50"
...
def main() -> None:
    ...
    OUTPUT_README.write_text(
        "\n".join(
            [
                "Merged classified view of WavCaps + Clotho + ESC-50 using the AudioSet-style 10-class heuristic taxonomy.",
                "This does not modify any original dataset.",
                "",
                "Files:",
                f"- {OUTPUT_METADATA.name}: merged rows plus primary_class, matched_classes, matched_keywords",
