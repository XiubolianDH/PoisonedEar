...
SOURCE_METADATA = Path("data/full_datasets/esc50/metadata.csv")
OUTPUT_DIR = Path("classified_dataset/esc50")
...
def main() -> None:
    ...
    OUTPUT_README.write_text(
        "\n".join(
            [
                "Separate classified ESC-50 view using the same 10-class heuristic taxonomy.",
