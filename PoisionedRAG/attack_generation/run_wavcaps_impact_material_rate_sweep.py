...
PLAN_PATH = REPO_ROOT / "attack_experiments" / "wavcaps_impact_material_rates" / "experiment_plan.json"
MALICIOUS_METADATA = REPO_ROOT / "malicious_dataset" / "unified_impact_material_10" / "final_dataset" / "query_subset_all.json"
OUTPUT_DIR = REPO_ROOT / "outputs" / "wavcaps_impact_material_rate_sweep"
