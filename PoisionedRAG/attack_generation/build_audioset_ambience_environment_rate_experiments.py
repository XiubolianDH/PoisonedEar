...
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_ambience_environment_3/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_ambience_environment_rates")
TARGET_CLASS = "ambience_environment"
