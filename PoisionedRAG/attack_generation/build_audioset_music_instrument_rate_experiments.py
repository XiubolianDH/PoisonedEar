...
MALICIOUS_METADATA = Path(
    "malicious_dataset/wavcaps_clotho_esc50_to_audioset_music_instrument_155/final_dataset/metadata.json"
)
OUTPUT_DIR = Path("attack_experiments/audioset_music_instrument_rates")
TARGET_CLASS = "music_instrument"
TARGET_CLASS_SIZE = 777
RATES = [1, 5, 10, 15, 20]
SEED = 7
